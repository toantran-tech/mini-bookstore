...
public class EmailServiceImpl implements EmailService {
  ...
  public void sendOrderConfirmationEmail(User user, Order order) {
    ...
    try {
      ...
      for (OrderDetail detail : order.getOrderDetails()) {
        ...
        itemRows.append(
            """
                ...
                """
                .formatted(title, qty, price.multiply(BigDecimal.valueOf(qty))));
      }
      ...
      String discountRow = order.getDiscountAmount() != null
          ...
          ? """
              ...
              """.formatted(order.getCouponCode(), order.getDiscountAmount().doubleValue())
          : "";
      ...
      String html = """
          ...
          .formatted(
              ...
              itemRows.toString(),
              order.getShippingFee() == null || order.getShippingFee().compareTo(java.math.BigDecimal.ZERO) == 0
                  ? "Miễn phí" : String.format(Locale.US, "%,.0fđ", order.getShippingFee().doubleValue()),
              discountRow,
